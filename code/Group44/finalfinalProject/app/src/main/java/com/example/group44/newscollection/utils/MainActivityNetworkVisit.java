...
public class MainActivityNetworkVisit {
    // 存放结果
    private ArrayList< List<Feed> > listOfFeedList = new ArrayList<>();
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                if(result < setOfUrls.size() - 1){
                                    ...
                                    // 选择5则新闻
                                    // 用户选择
                                    for(int i = 0; i < listOfFeedList.size(); i++){
                                        for(Feed e : listOfFeedList.get(i)){
                                            if(e.getTitle().equals("")) continue;
                                            feedList.add(e);
                                        }
                                    }
                                    for(Feed e : feedList){
                                        Log.i("result", e.getTitle());
                                    }
